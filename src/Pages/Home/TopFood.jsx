...
const TopFood = () => {
    ...
    return (
        <div className="flex justify-center my-8">
            <div className="">
             <h2 data-aos="fade-up" className="text-4xl my-8 text-center font-bold">Top 6 Products</h2>
             <h2 data-aos="fade-up" className="text-2xl text-center mb-8">Elevate your dining experience at PIZZAN! Our websites inviting banner welcomes <br /> you with a tantalizing glimpse of our exquisite dishes and warm ambiance.</h2>
